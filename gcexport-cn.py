...
Activity & event types:
    https://connect.garmin.cn/modern/main/js/properties/event_types/event_types.properties
    https://connect.garmin.cn/modern/main/js/properties/activity_types/activity_types.properties
"""
...
BASE_URL = "https://connect.garmin.cn/en-US/signin"
SSO = "https://sso.garmin.cn/sso"
CSS = "https://static.garmincdn.cn/com.garmin.connect/ui/css/gauth-custom-v1.2-min.css"
...
URL_GC_LOGIN = 'https://sso.garmin.cn/sso/signin?' + urlencode(DATA)
URL_GC_POST_AUTH = 'https://connect.garmin.cn/modern/activities?'
URL_GC_PROFILE = 'https://connect.garmin.cn/modern/profile'
URL_GC_USERSTATS = 'https://connect.garmin.cn/modern/proxy/userstats-service/statistics/'
URL_GC_LIST = 'https://connect.garmin.cn/modern/proxy/activitylist-service/activities/search/activities?'
...
URL_GC_GEAR = 'https://connect.garmin.cn/modern/proxy/gear-service/gear/filterGear?activityId='
URL_GC_ACT_PROPS = 'https://connect.garmin.cn/modern/main/js/properties/activity_types/activity_types.properties'
URL_GC_EVT_PROPS = 'https://connect.garmin.cn/modern/main/js/properties/event_types/event_types.properties'
...
URL_GC_ORIGINAL_ACTIVITY = 'http://connect.garmin.cn/proxy/download-service/files/activity/'
...
def csv_write_record(csv_filter, extract, actvty, details, activity_type_name, event_type_name):
    ...
    csv_filter.set_column('url', 'https://connect.garmin.cn/modern/activity/' + str(actvty['activityId']))
